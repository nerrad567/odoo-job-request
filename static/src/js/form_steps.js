        ...
        <form t-ref="form" t-on-submit.prevent="submitForm">
            <div t-if="state.current_step === 1">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="first_name" t-model="state.first_name" class="form-control" autocapitalize="words" t-on-input="(ev) => this.validateField('first_name')" t-on-blur="(ev) => this.validateField('first_name')"/>
                    <small t-if="state.errors.first_name" class="text-danger"><t t-esc="state.errors.first_name"/></small>
                </div>
                <div class="form-group">
                    <label for="email">Email <span style="color: red;">*</span></label>
                    <input type="email" id="email" t-model="state.email" class="form-control" t-on-input="(ev) => this.validateField('email')" t-on-blur="(ev) => this.validateField('email')"/>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="postcode" t-model="state.postcode" class="form-control" maxlength="10" t-on-blur="validatePostcode" t-on-input="(ev) => this.validateField('postcode')"/>
            ...
            <div t-if="state.job_type === 'new_socket' &amp;&amp; state.current_step === 2">
                ...
                <div class="form-group">
                    ...
                    <small t-if="state.errors.gas_is_present" class="text-danger"><t t-esc="state.errors.gas_is_present"/></small>
                ...
                <div class="form-group">
                    ...
                    <small t-if="state.errors.oil_is_present" class="text-danger"><t t-esc="state.errors.oil_is_present"/></small>
                ...
                <div class="form-group">
                    ...
                    <small t-if="state.errors.other_services_is_present" class="text-danger"><t t-esc="state.errors.other_services_is_present"/></small>
                    <div t-if="state.other_services_is_present === 'true'">
                        ...
                        <label>Photo</label>
                        <input type="file" t-on-change="(ev) => this.handleSingleFileChange('other_services_photo_attachment', ev)" accept="image/*" class="form-control"/>
                        <div t-if="state.other_services_photo_attachment" class="mt-2 d-flex flex-wrap">
                            <div class="m-1">
                                <img t-att-src="state.other_services_photo_attachment.thumbnail || ''" style="max-width: 100px;"/>
                                <span t-esc="state.other_services_photo_attachment.name"/>
                                <button type="button" t-on-click="() => this.handleRemoveSingle('other_services_photo_attachment')" class="btn btn-sm btn-danger ml-2">Remove</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div t-if="state.job_type === 'new_socket' &amp;&amp; state.current_step === 3">
                ...
                <div class="form-group">
                    ...
                    <select t-model="state.building_type" class="form-control" t-on-change="() => this.validateField('building_type')">
                        <option value="">Select...</option>
                ...
                <div class="form-group">
                    ...
                    <select t-model="state.construction_age" class="form-control" t-on-change="() => this.validateField('construction_age')">
                        <option value="">Select...</option>
